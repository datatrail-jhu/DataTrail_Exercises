...
Congrats! We just did the steps of a data science project! Now its your turn to add to this!
...
4. In the menu, go to File > Save. Now the `nb.html` output resulting file will have your new output saved to it. 

5. Open up the resulting `first_project.nb.html` file and click `View in Web Browser`. Does it look good to you? 
